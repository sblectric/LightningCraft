...
/** The kinetic axe */
public class ItemKineticAxe extends ItemAxeLC implements IInventoryLEUser, IKineticRepair {
	
	public static final double attackDamage = 9;

	public ItemKineticAxe(ToolMaterial mat) {
		super(mat);
	}
	...
	public void onUpdate(ItemStack a, World world, Entity player, int par4, boolean par5) {		
		// LP operations (can't do them in the efficiency method)
    ...
    public boolean hitEntity(ItemStack stack, EntityLivingBase entity, EntityLivingBase user) {
		InventoryLE.hitEntity(stack, entity, user, attackDamage, false); // axe peaks at 6 damage
