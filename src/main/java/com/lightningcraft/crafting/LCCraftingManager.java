...
import com.lightningcraft.blocks.BlockLight;
import com.lightningcraft.blocks.BlockSlabLC;
import com.lightningcraft.blocks.BlockStone;
import com.lightningcraft.blocks.BlockUnderOre;
...
import com.lightningcraft.recipes.LCFuelHandler;
...
public class LCCraftingManager {
	...
	private static void addCraftingRecipes() {
		...
		RecipeHelper.addShapedOreRecipe(new ItemStack(LCBlocks.lightningCannon, 1, 1), "ERE","ICI","ETE", 
				'C',new ItemStack(LCItems.material, 1, Material.CANNON_CORE), 'I',"rodIron", 'E',"blockElectricium", 'T',Blocks.TNT, 'R',Items.COMPARATOR);
