...
public class LightningInfusionRecipes {
	...
	private void addDefaultRecipes() {
		...
		// potions
		addRecipe(new ItemStack(LCItems.potion, 1, LCPotions.demonFriendMeta), 50, 
				new ItemStack(Items.POTIONITEM), demonBlood, Items.GOLDEN_CARROT, demonBlood, Items.GOLDEN_CARROT);
		addRecipe(new ItemStack(LCItems.potion, 1, LCPotions.demonFriendExtMeta), 25, 
				new ItemStack(LCItems.potion, 1, LCPotions.demonFriendMeta), LCMisc.makeArray("dustRedstone", 4));
