...
public class GuiLightningCannon extends GuiContainer {
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		...
		// titles
		String string = new ItemStack(LCBlocks.lightningCannon, 1, 1).getDisplayName();
		...
		// available LP
		int color = 4210752;
		Double power = tileCannon.getActualNeededPower(TileEntityLightningCannon.lePerAttack);
