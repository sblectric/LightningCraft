...
/** The lightning static generator */
public class BlockStaticGenerator extends BlockContainerLC implements IFurnace {
	...
	/** The lightning static generator */
	public BlockStaticGenerator() {
		super(Blocks.QUARTZ_BLOCK, 10, 100);
	...
	public void randomDisplayTick(IBlockState state, World world, BlockPos pos, Random rand) {
		if(isBurning(state, world, pos)) {
			...
			world.spawnParticle(EnumParticleTypes.FIREWORKS_SPARK, d0 - d3, d1, d2 + d4, 0.0D, 0.0D, 0.0D);
			world.spawnParticle(EnumParticleTypes.FIREWORKS_SPARK, d0 + d3, d1, d2 + d4, 0.0D, 0.0D, 0.0D);
			world.spawnParticle(EnumParticleTypes.FIREWORKS_SPARK, d0 + d4, d1, d2 - d3, 0.0D, 0.0D, 0.0D);
			world.spawnParticle(EnumParticleTypes.FIREWORKS_SPARK, d0 + d4, d1, d2 + d3, 0.0D, 0.0D, 0.0D);
		}
	}
