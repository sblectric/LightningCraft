...
public class WorldUtils {
	...
	/** Estimate an entity's position after a duration of velocity */
	public static Vec3d estimateEntityPosition(Entity e, double originX, double originY, double originZ, double speed) {
		double ticks = e.getDistance(originX, originY, originZ) / speed;
		double resultX, resultY, resultZ;
		resultX = e.motionX * ticks + e.posX;
		resultY = (e.motionY + 0.0784) * ticks + e.posY;
		resultZ = e.motionZ * ticks + e.posZ;
