...
public class GuiLightningMiner extends GuiContainerLC {
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		...
		// operating mode
		this.fontRenderer.drawString("Operating Mode", modeButtonX, modeBtn.y - 9 - this.guiTop, 4210752);
		modeBtn.displayString = tile.mode.getName();
		
		// replace blocks?
		this.fontRenderer.drawString("Replace Blocks?", replaceButtonX, replaceBtn.y - 9 - this.guiTop, 4210752);
